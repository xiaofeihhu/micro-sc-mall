...
import com.znv.demo.application.ApplicationContextHelper;
...
public class RedisUtil {
    ...
    private static RedisTemplate<String, Object> redisTemplate = (RedisTemplate<String, Object>) ApplicationContextHelper.getBean("redisTemplate");
